<?php
/**
 * Class for the import actions used in the Catch Themes Demo Import plugin.
 * Register default WP actions for CTDI plugin.
 *
 * @package ctdi
 */
...
class ImportActions
{
	...
	/**
	 * Execute the action: 'cp-ctdi/before_content_import'.
	 *
	 * @param array $selected_import_files Actual selected import files (content, widgets, customizer, redux).
	 * @param array $import_files          The filtered import files defined in `cp-ctdi/import_files` filter.
	 * @param int   $selected_index        Selected index of import.
	...
	/**
	 * Execute the action: 'cp-ctdi/before_widgets_import'.
	 *
	 * @param array $selected_import_files Actual selected import files (content, widgets, customizer, redux).
	 * @param array $import_files          The filtered import files defined in `cp-ctdi/import_files` filter.
	 * @param int   $selected_index        Selected index of import.
	...
	/**
	 * Execute the action: 'cp-ctdi/after_import'.
	 *
	 * @param array $selected_import_files Actual selected import files (content, widgets, customizer, redux).
	 * @param array $import_files          The filtered import files defined in `cp-ctdi/import_files` filter.
	 * @param int   $selected_index        Selected index of import.
