<?php
/**
 * Class for the customizer importer used in the Catch Themes Demo Import plugin.
 *
	...
	public static function import($customizer_import_file_path)
	{
		...
		if (is_wp_error($results)) {
			...
			Helpers::append_to_file(
				$error_message,
				$log_file_path,
				esc_html__('Importing customizer settings', 'catch-themes-demo-import')
			);
		} else {
			// Add this message to log file.
			$log_added = Helpers::append_to_file(
				esc_html__('Customizer settings import finished!', 'catch-themes-demo-import'),
				$log_file_path,
				esc_html__('Importing customizer settings', 'catch-themes-demo-import')
			);
		}
	...
	public static function import_customizer_options($import_file_path)
	{
		...
		if ($new_data_template !== $new_template) {
			return new \WP_Error(
				...
				esc_html__('Error: The customizer import file is not suitable for current theme. You can only import customizer settings for the same theme or a child theme.', 'catch-themes-demo-import')
			);
		}
