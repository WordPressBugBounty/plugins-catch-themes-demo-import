...
class CatchThemesThemePlugin
{
	...
	{
		// Add our filter here
		$tabs['catchplugins'] = _x('Catch Plugins', 'Plugin Installer', 'catch-themes-demo-import');
	...
	public function plugins_table()
	{
		...
		printf(
			...
			sprintf(
				...
				wp_kses_post(__('You can use any of our free plugins or premium plugins from <a href="%s" target="_blank">Catch Plugins</a>.', 'catch-themes-demo-import')),
